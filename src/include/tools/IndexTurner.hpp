...
using namespace std;
/*
In this subgraph isomorphism algorithm ,node id's and label's types are size_t
So in case of they are not size_t, such as string, IndexTurner can turn it to unique id (of course type is size_t).
...
*/
namespace wg {
template<typename _NameType, typename _IndexType = map<_NameType, size_t> >
class IndexTurner {
public:
